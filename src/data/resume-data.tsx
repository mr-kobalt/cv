  ...
  cover_letter: {
    qsoft: {
      ...
      letter: [
        ...
        "Я впечатлён, что внутри вашей команды родились такие проекты как **amoCRM** и **[Teamly](https://teamly.ru)**. Мне интересно поучаствовать в развитии последнего, учитывая мой опыт развития фирменной базы знаний на базе [coda.io](https://coda.io).",
      ],
    },
  },
  summary:
    "14 лет опыт работы в\u00a0IT-интеграторах России. Люблю IT во\u00a0всех проявлениях. Склонен к\u00a0системному подходу и\u00a0анализу данных. Изучаю мануалы прежде чем спросить. Выбираю обучение через практику. Пропагандирую data-driven и\u00a0вероятностный подходы в\u00a0бизнесе (и\u00a0жизни). Стремлюсь участвовать в\u00a0сложных и\u00a0полезных проектах. Люблю ответственность.",
  ...
  work: [
    {
      ...
      achievements: [
        ...
        "Моей командой реализовано: внедрение облачных сервисов Azure/365; система управления проектами Wrike; база знаний coda.io; система управления заказами на базе решений 1C; система управления продажами на базе Битрикс24; управленческая отчётность на базе DataLens"
      ],
      quit: [
