  ...
  variants: {
    ...
    okkam: {
      ...
      cover_letter: {
        ...
        logo: OkkamLogo,
        letter: [
          "Добрый день, уважаемый представитель **[Okkam](https://okkam.group)**!",
          "Предлагаю рассмотреть моё резюме на должность **[Junior Data scientist](https://hh.ru/vacancy/112763125)**. Я перезапускаю карьеру в IT и хочу сфокусироваться на\u00a0**создании продуктов** основанных на\u00a0**анализе данных** и\u00a0**машинном обучении**.",
          "Из релевантного опыта - создание дашбордов для руководителей нашей компании в **DataLens**, с выгрузкой из баз **Битрикс** и **1С**, используя **bash**-скрипты, **Python**, **SQL**. Большой опыт в бизнес-аналитике и презентации результатов внутреннему заказчику. Опыт работы с **Git**, **CI/CD**, **Docker** имеется для личных задач. Представление о математической статистике, теории вероятностей, алгоритмах оптимизации имеется, но в рабочих задачах не использовал.",
          "Буду рад обсудить возможное сотрудничество."
        ]
      }
    },
    sape: {
      ...
      cover_letter: {
        ...
        logo: SapeLogo,
        letter: [
          "Добрый день, уважаемый представитель **[Sape](https://sape.ru)**!",
          "Предлагаю рассмотреть моё резюме на должность **[Junior Data scientist](https://hh.ru/vacancy/113155326)**. Я перезапускаю карьеру в IT и хочу сфокусироваться на\u00a0**создании продуктов** основанных на\u00a0**анализе данных** и\u00a0**машинном обучении**.",
          "Описанный в вакансии технологический стек мне знаком, но в работе я использовал только **Python+Numpy/Pandas** и **SQL**. **Skikit**, **Mathplotlib/Seaborn** использовал только в рамках курсов по машинному обучению.",
          "Из релевантного опыта - создание дашбордов для руководителей нашей компании в **DataLens**, с выгрузкой из баз **Битрикс** и **1С**.",
          "Буду рад обсудить возможное сотрудничество."
        ]
      }
    },
    metalead: {
      ...
      cover_letter: {
        ...
        logo: MetaLeadLogo,
        letter: [
          "Добрый день, уважаемый представитель **[metaLead](https://metalead.group)**!",
          "Предлагаю рассмотреть моё резюме на должность **[Аналитик (Big Data/Data Science)](https://hh.ru/vacancy/115383081)**. Я перезапускаю карьеру в IT и хочу сфокусироваться на\u00a0**создании продуктов** основанных на\u00a0**анализе данных** и\u00a0**машинном обучении**.",
          "Cоответствие вашим требованиям: **SQL/PostgreSQL/Power Pivot, сводные таблицы Excel** - всё это хорошо знакомо; с **OLAP** ещё не работал, не было необходимости; **мат. статистика, построение моделей данных, методы big data и data science** - проходил на курсах несколько лет назад, но на практике не применял; работы в системах **BI / ERP / CRM** - работал в DataLens, 1C/Axapta, Битрикс24/AmoCRM (см. ниже раздел **Проекты**); знаком с **Python** - делал пару телеграмм-ботов и разные middleware скрипты.",
          "Буду рад обсудить возможное сотрудничество."
        ]
      }
    },
